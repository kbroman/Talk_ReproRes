...
web: $(STEM).pdf $(STEM)_withnotes.pdf
	scp $(STEM).pdf broman-10.biostat.wisc.edu:public_html/presentations/$(STEM)_SIBS2015.pdf
	scp $(STEM)_withnotes.pdf broman-10.biostat.wisc.edu:public_html/presentations/$(STEM)_SIBS2015_withnotes.pdf
