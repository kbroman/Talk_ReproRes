...
web: $(STEM).pdf $(STEM)_withnotes.pdf
	scp $(STEM).pdf broman-10.biostat.wisc.edu:Website/presentations/steps2rr.pdf
	scp $(STEM)_withnotes.pdf broman-10.biostat.wisc.edu:Website/presentations/steps2rr_withnotes.pdf
