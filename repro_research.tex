...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/jax2017-05}{\tt \scriptsize
  \color{foreground} bit.ly/jax2017-05}
}
...
\frame{
  ...
  \note{These are slides for a talk I've given a whole bunch of times,
    most recently for a course on Big Genomic Data at the Jackson Lab,
    on 17 may 2017.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt http://bit.ly/jax2017-05\_nonotes} \\
    With notes: {\tt http://bit.ly/jax2017-05}
}
} }
...
Slides: \href{http://bit.ly/jax2017-05}{\tt bit.ly/jax2017-05} \quad
