...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/RDS_2015}{\tt \scriptsize
  \color{foreground} bit.ly/RDS\_2015}
}
...
\frame{
  ...
  \note{These are slides for a talk I gave for the Molecular
    ...
    Nov 2015, and in the Holz Series in Research
    Data Management at UW-Madison on 18 Nov 2015.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt http://bit.ly/RDS\_2015\_nonotes} \\
    With notes: {\tt http://bit.ly/RDS\_2015}
}
} }
...
Slides: \href{http://bit.ly/RDS_2015}{\tt bit.ly/RDS\_2015} \quad
