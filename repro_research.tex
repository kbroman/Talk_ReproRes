...
\frame{
  ...
  \note{These are slides for a talk I've given a whole bunch of times,
    most recently for the Summer Research Program in Biomedical Data
    Science at UW-Madison on 11 July 2018.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt https://bit.ly/steps2rr\_nonotes} \\
    With notes: {\tt https://bit.ly/steps2rr}
}
} }
