...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/Chi2016}{\tt \scriptsize
  \color{foreground} bit.ly/Chi2016}
}
...
\frame{
  ...
  \note{These are slides for a talk I gave for the Molecular
    ...
    Data Management at UW-Madison on 18 Nov 2015, and at a Chicago ASA
    Chapter meeting on Reproducible Research on 1 Apr 2016.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt http://bit.ly/Chi2016\_nonotes} \\
    With notes: {\tt http://bit.ly/Chi2016}
}
} }
...
Slides: \href{http://bit.ly/Chi2016}{\tt bit.ly/Chi2016} \quad
