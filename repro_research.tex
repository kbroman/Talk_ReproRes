...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/UMass2016}{\tt \scriptsize
  \color{foreground} bit.ly/UMass2016}
}
...
\frame{
  ...
  \note{These are slides for a talk I gave for the Molecular
    Microbial Ecology and Evolution (MoMiEE) group at UW-Madison on 11
    May 2015, the annual retreat of the Center for
    Genome Dynamics, Jackson Lab, on 28 May 2015,
    the Summer Institute for Training in Biostatistics (SIBS) at
    UW-Madison on 9 July 2015, at the Division of Biostatistics,
    University of Tennessee Health Science Center, Memphis, TN, on 4
    Nov 2015, in the Holz Series in Research
    Data Management at UW-Madison on 18 Nov 2015, at a Chicago ASA
    Chapter meeting on Reproducible Research on 1 Apr 2016,
    and to the Graduate Researchers interested in Data (GRiD) at UMass
    Amherst on 11 Apr 2016.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt http://bit.ly/UMass2016\_nonotes} \\
    With notes: {\tt http://bit.ly/UMass2016}
}
} }
...
\item In addition to {\color{hilit} what} was done, is it clear
  ...
  \bi
  \item[] (e.g., why did you omit those six subjects?)
  \ei
...
Slides: \href{http://bit.ly/UMass2016}{\tt bit.ly/UMass2016} \quad
