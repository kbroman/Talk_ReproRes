...
\only<1|handout 0>{\figw{Figs/example_Rmd.png}{0.92}}
\only<2>{\figw{Figs/example_Rmd_source.png}{0.92}}
...
\begin{frame}[c]{6. Create a package/module}
  ...
  \note{It's surprisingly easy to create an R package (see
    {\tt http://kbroman.org/pkg_primer}) and it's even easier to make
    a Python module.
...
\only<1|handout 0>{\figh{Figs/phd101212s.png}{0.8}}

\only<2|handout 0>{\figh{Figs/example_repo}{0.80}}
\only<3|handout 0>{\figh{Figs/example_repo_zoom}{0.55}}
\only<4>{\figh{Figs/example_history}{0.80}}
\only<5>{\figh{Figs/example_commit}{0.80}}
