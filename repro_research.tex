...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/ComBEE2016}{\tt \scriptsize
  \color{foreground} bit.ly/ComBEE2016}
}
...
\frame{
  ...
  \note{These are slides for a talk I've given a whole bunch of times,
    most recently at UW-Madison for the Computational Biology,
    Ecology, \& Evolution group, on 25 May 2016.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt http://bit.ly/ComBEE2016\_nonotes} \\
    With notes: {\tt http://bit.ly/ComBEE2016}
}
} }
...
Slides: \href{http://bit.ly/ComBEE2016}{\tt bit.ly/ComBEE2016} \quad
