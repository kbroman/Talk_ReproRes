...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/bds2017-06}{\tt \scriptsize
  \color{foreground} bit.ly/bds2017-06}
}
...
\frame{
  ...
  \note{These are slides for a talk I've given a whole bunch of times,
    ...
    Slides: {\tt http://bit.ly/bds2017-06\_nonotes} \\
    With notes: {\tt http://bit.ly/bds2017-06}
}
} }
