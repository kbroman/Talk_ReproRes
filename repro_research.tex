...
\scriptsize {\lolit Slides:} \href{https://bit.ly/steps2rr}{\tt
  \color{foreground} kbroman.org/Talk\_RepoRes}
}
...
\frame{
  ...
  \note{This lecture is based on slides for a talk I've given a whole
    ...
    \qquad {\tt https://kbroman.org/Talk\_ReproRes/repro\_research\_withnotes.pdf} \\
    Full slides without notes: {\tt https://kbroman.org/Talk\_ReproRes}
...
Slides: \href{https://kbroman.org/Talk_ReproRes}{\tt kbroman.org/Talk\_ReproRes} \quad
