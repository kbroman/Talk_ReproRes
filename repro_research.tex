...
\frame{
  ...
  \note{These are slides for a talk I gave for the Molecular
    ...
    the Summer Institute in Biostatistics at UW-Madison, on 9 July 2015.
...
{\lolit
{\textendash}
\only<1>{\href{http://www.stat.ubc.ca/~jenny/}{Jenny Bryan}}
