...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/SIBS2015}{\tt \scriptsize
  \color{foreground} bit.ly/SIBS2015}
}
...
\frame{
  ...
  \note{These are slides for a talk I gave for the Molecular
    ...
    May 2015, as well as for the annual retreat of the Center for
    Genome Dynamics, Jackson Lab, on 28 May 2015, and then also for
    the Summer Institute for Training in Biostatistics (SIBS) at
    UW-Madison, on 9 July 2015.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt http://bit.ly/SIBS2015\_nonotes} \\
    With notes: {\tt http://bit.ly/SIBS2015}
...
\begin{frame}[c]{6. Create an R package}
  ...
  \note{It's surprisingly easy to create an R package (see
    {\tt http://kbroman.org/pkg\_primer}).

    When writing functions, try to write them in a somewhat-general
    way and then pull them out of the project as separate package,
...
Slides: \href{http://bit.ly/SIBS2015}{\tt bit.ly/SIBS2015} \quad
