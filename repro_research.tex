...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/Memphis2015b}{\tt \scriptsize
  \color{foreground} bit.ly/Memphis2015b}
}
...
\frame{
  ...
  \note{These are slides for a talk I gave for the Molecular
    ...
    UW-Madison, on 9 July 2015, and the Division of Biostatistics,
    University of Tennessee Health Science Center, Memphis, TN, on 4
    Nov 2015.

    Source: {\tt https://github.com/kbroman/Talk\_ReproRes} \\
    Slides: {\tt http://bit.ly/Memphis2015b\_nonotes} \\
    With notes: {\tt http://bit.ly/Memphis2015b}
}
} }
